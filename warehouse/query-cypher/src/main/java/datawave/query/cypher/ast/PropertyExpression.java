...
/**
 * A dotted property access: {@code variable.prop} or a chain {@code variable.prop.nested}. Most Cypher property access is a single hop; the grammar allows
 * chaining so we preserve the full path.
 */
